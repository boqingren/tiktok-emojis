...
export function Wronged(props: Partial<Record<"width" | "height" | "size", string | number>>): JSX.Element {
  return (
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689606296240">
    <circle className="wronged_fil0" cx="19.95" cy="19.95" r="19.95" />
    <circle className="wronged_fil1" cx="19.86" cy="24.16" r="2.82" />
    <circle className="wronged_fil1" cx="33.4" cy="24.16" r="2.55" />
    <path className="wronged_fil1"
