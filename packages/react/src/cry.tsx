...
export function Cry(props: Partial<Record<"width" | "height" | "size", string | number>>): JSX.Element {
  return (
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689539983632">
    <circle className="cry_fil0" cx="15.13" cy="15.13" r="15.13" />
    <g>
      <path className="cry_fil1"
