...
export function Weep(props: Partial<Record<"width" | "height" | "size", string | number>>): JSX.Element {
  return (
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689613694000">
    <circle className="weep_fil0" cx="20.01" cy="20.01" r="20.01" />
    <g>
      <g>
        <path className="weep_fil1"
