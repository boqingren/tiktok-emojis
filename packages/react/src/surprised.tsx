...
export function Surprised(props: Partial<Record<"width" | "height" | "size", string | number>>): JSX.Element {
  return (
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689590897968">
    <circle className="surprised_fil0" cx="18.76" cy="19.63" r="18.76" />
    <ellipse className="surprised_fil1" cx="18.76" cy="27.59" rx="1.39" ry="4.64" />
    <path className="surprised_fil1"
    ...
    <circle className="surprised_fil2" cx="26.82" cy="16.5" r="7.2" />
    <circle className="surprised_fil1" cx="26.82" cy="16.5" r="2.73" />
    <circle className="surprised_fil2" cx="10.69" cy="16.5" r="7.2" />
    <circle className="surprised_fil1" cx="10.7" cy="16.5" r="2.73" />
  </g>
</g>
</svg>
  );
