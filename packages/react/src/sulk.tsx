...
export function Sulk(props: Partial<Record<"width" | "height" | "size", string | number>>): JSX.Element {
  return (
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689604902000">
    <circle className="sulk_fil0" cx="18.76" cy="18.76" r="18.76" />
    <path className="sulk_fil1"
