...
export function Facewithrollingeyes(props: Partial<Record<"width" | "height" | "size", string | number>>): JSX.Element {
  return (
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689533366944">
    <circle className="facewithrollingeyes_fil0" cx="15.88" cy="15.88" r="15.88" />
    <circle className="facewithrollingeyes_fil1" cx="22.71" cy="14.83" r="5.92" />
    <path className="facewithrollingeyes_fil2"
    ...
    <circle className="facewithrollingeyes_fil1" cx="9.05" cy="14.83" r="5.92" />
    <path className="facewithrollingeyes_fil2"
