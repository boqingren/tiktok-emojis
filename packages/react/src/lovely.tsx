...
export function Lovely(props: Partial<Record<"width" | "height" | "size", string | number>>): JSX.Element {
  return (
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689419028208">
    <circle className="lovely_fil0" cx="17.74" cy="17.74" r="17.74" />
    <ellipse className="lovely_fil1" cx="27.03" cy="11" rx="4.41" ry="2.63" />
    <ellipse className="lovely_fil1" cx="8.45" cy="11" rx="4.41" ry="2.63" />
    <path className="lovely_fil2"
