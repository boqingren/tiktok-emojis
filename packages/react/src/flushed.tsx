...
export function Flushed(props: Partial<Record<"width" | "height" | "size", string | number>>): JSX.Element {
  return (
...
<g id="Layer_x0020_1">
  ...
  <g id="_2690720500640">
    <circle className="flushed_fil0" cx="15.88" cy="15.88" r="15.88" />
    <path className="flushed_fil1"
    ...
    <circle className="flushed_fil1" cx="15.14" cy="23.24" r="3.98" />
    <path className="flushed_fil2"
    ...
    <circle className="flushed_fil2" cx="16.93" cy="18.43" r="2.25" />
    <circle className="flushed_fil2" cx="26.84" cy="16.95" r="1.93" />
  </g>
</g>
</svg>
  );
