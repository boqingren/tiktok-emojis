...
export const Funnyface = defineComponent({
  name: "Funnyface",
  props: {
    width: {
      type: [String, Number],
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689536525008">
    <circle class="funnyface_fil0" cx="16.76" cy="16.76" r="16.76" />
    <circle class="funnyface_fil1" cx="11.18" cy="8.82" r="2.4" />
    <path class="funnyface_fil1"
