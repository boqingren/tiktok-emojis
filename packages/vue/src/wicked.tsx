...
export const Wicked = defineComponent({
  name: "Wicked",
  props: {
    width: {
      type: [String, Number],
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689600652864">
    ...
    <circle class="wicked_fil1" cx="20.96" cy="26.71" r="16.07" />
    <path class="wicked_fil2"
      d="M22.71 27.01l10.91 -2.55c0.4,6.09 -8.17,9.08 -10.91,2.55z" />
    <path class="wicked_fil2"
      d="M19.2 27.01l-10.91 -2.55c-0.4,6.09 8.17,9.08 10.91,2.55z" />
    <polygon class="wicked_fil3" points="29.66,32.44 29.64,35.98 27.6,34.24 " />
    <path class="wicked_fil2"
