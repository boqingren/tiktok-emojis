...
export const Happy = defineComponent({
  name: "Happy",
  props: {
    width: {
      type: [String, Number],
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689361941296">
    <circle class="happy_fil0" cx="16.76" cy="16.76" r="16.76" />
    <g>
      <path class="happy_fil1"
      ...
      <circle class="happy_fil2" cx="26.47" cy="11.43" r="3.6" />
      <circle class="happy_fil2" cx="7.04" cy="11.43" r="3.6" />
      <path class="happy_fil1"
