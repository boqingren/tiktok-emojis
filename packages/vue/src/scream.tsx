...
export const Scream = defineComponent({
  name: "Scream",
  props: {
    width: {
      type: [String, Number],
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689536548304">
    <circle class="scream_fil0" cx="17.74" cy="17.74" r="17.74" />
    <circle class="scream_fil1" cx="16.85" cy="19.66" r="15" />
    <circle class="scream_fil2"
