...
export const Shout = defineComponent({
  name: "Shout",
  props: {
    width: {
      type: [String, Number],
...
<g id="Layer_x0020_1">
  ...
  <g id="_2689536548592">
    <circle class="shout_fil0" cx="17.74" cy="17.74" r="17.74" />
    <circle class="shout_fil1" cx="17.74" cy="19.91" r="15.46" />
    <path class="shout_fil2"
